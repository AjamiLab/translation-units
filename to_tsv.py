...
###############
# A script to convert from a markdown txt file of source language
...
#
# The main use of this script is to convert a plain text file with footnotes
# and basic formatting written
# using the conventions of [pandoc](https://pandoc.org/) flavored
# [Markdown](https://daringfireball.net/projects/markdown/)
# into a TSV file without foonotes or formatting
